  ...
  return (
    <div className="flex-1">
      <div className="mb-5 flex items-center gap-2">
        <div className="h-[7px] w-[7px] rounded-full bg-[#ffa003]"></div>
        <p className="font-montserrat font-semibold text-[#191919]">Blood Glucose Level</p>
      </div>
        ...
        <Table className="">
          ...
          <TableHeader className="bg-gray-100">
            <TableRow className="font-montserrat font-semibold">
              ...
              <TableHead>Glucose Level(mmol/L)</TableHead>
            ...
            {metrics?.map((metric) => (
              <TableRow key={metric.id} className="font-montserrat">
                ...
                <TableCell className="flex gap-3">
                  <EditHealthData metric={metric} type="blood-glucose">
