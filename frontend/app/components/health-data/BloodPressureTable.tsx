    ...
    <div className="flex-1">
      <div className="mb-5 flex gap-6">
        <div className="flex items-center gap-2">
          ...
          <p className="font-montserrat font-semibold text-[#191919]">Systolic Blood Pressure</p>
        </div>

        <div className="flex items-center gap-2">
          <div className="h-[7px] w-[7px] rounded-full bg-[#FFA000]"></div>
          <p className="font-montserrat font-semibold text-[#191919]">Diastolic Blood Pressure</p>
        </div>
      </div>
          ...
          <TableBody>
            {metrics?.map((metric) => (
              <TableRow key={metric.id} className="font-montserrat">
                ...
                <TableCell>{metric.systolic}</TableCell>
                <TableCell>{metric.diastolic}</TableCell>
                <TableCell className="flex gap-3">
                  <EditHealthData metric={metric} type="blood-pressure">
